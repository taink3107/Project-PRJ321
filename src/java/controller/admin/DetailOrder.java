...
public class DetailOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int orderID = Integer.valueOf(request.getParameter("orId"));
           List<BillElement> allByBillId = new BillDAO().getAllByBillId(orderID);
           request.setAttribute("detail", allByBillId);
          // response.getWriter().print(allByBillId);
