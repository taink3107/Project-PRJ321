 ...
 */
@WebServlet(name = "ProductControl", urlPatterns = {"/admin-controlProduct"})
public class ProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("controlProduct.jsp").forward(request, response);
        }
    }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!isMultiPart) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        try {
                            ...
                            String partUpload = readPart.replace("build\\", "") + "img\\male\\" + fileName;
             ...
             //   String description = (String) params.get("description");
              //  int status = Integer.valueOf(1);
              new ProductDao().remove(1031);
                Product p = Product.builder()
                        ...
                        .description("AHIHI")
                        .status(1)
                        .image(lsFileName.get(0))
                        .build();
                boolean isCheck = new ProductDao().add(p);
                response.getWriter().print(isCheck);
                if (isCheck) {
                    // add successfully
